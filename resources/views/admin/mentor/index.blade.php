<x-layouts.admin title="Manajemen Mentor">
    ...
    @else
        {{-- Table Container --}}
        <div class="bg-white/5 border border-white/10 rounded-[40px] overflow-hidden shadow-2xl">
                            ...
                            <tr class="group hover:bg-white/[0.02] transition-colors">
                                ...
                                <td class="px-8 py-5">
                                    <div class="flex items-center gap-4">
                                        <div class="h-12 w-12 rounded-2xl overflow-hidden border border-white/10 bg-slate-800 shrink-0">
                                ...
                                {{-- Status (Boolean) --}}
                                <td class="px-6 py-5 text-center">
                                    <span class="h-2 w-2 inline-block rounded-full {{ $mentor->is_active ? 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)]' : 'bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.6)]' }}"></span>
                                </td>

                                {{-- Actions --}}
                                <td class="px-8 py-5 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('admin.mentor.edit', $mentor->id) }}" class="p-3 bg-white/5 hover:bg-blue-600 text-white rounded-xl transition-all">
