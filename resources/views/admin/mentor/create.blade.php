    ...
    <form action="{{ route('admin.mentor.store') }}" method="POST" enctype="multipart/form-data" class="max-w-6xl mx-auto pb-20">
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white/5 border border-white/10 rounded-md p-8 text-center shadow-2xl">
                    ...
                    <label for="photo-upload" class="relative block w-full aspect-square border-2 border-dashed border-white/10 rounded-md overflow-hidden cursor-pointer hover:bg-white/5 transition-all group">
            ...
            <div class="lg:col-span-2 space-y-8">
                <div class="bg-white/5 border border-white/10 rounded-md p-10 space-y-8 shadow-2xl">
                ...
                {{-- Tags Pengalaman --}}
                <div class="bg-white/5 border border-white/10 rounded-md p-10 space-y-6 shadow-2xl">
                ...
                {{-- Status Toggle --}}
                <div class="bg-white/5 border border-white/10 rounded-md p-8 flex items-center justify-between shadow-2xl">
                    <div>
